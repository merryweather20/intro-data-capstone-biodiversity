...
df = species.groupby('conservation_status')['scientific_name'].nunique()
print df
...
#Just over two weeks at Bryce National Park, just over a week at Yellowstone National Park
